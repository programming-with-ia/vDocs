...
/**
 * Custom hook that reads a value from [`localStorage`](https://developer.mozilla.org/en-US/docs/Web/API/Window/localStorage), closely related to [`useLocalStorage()`](https://programming-with-ia.github.io/vDocs/hooks/use-local-storage).
 * @template T - The type of the stored value.
 ...
 * @public
 * @see [Documentation](https://programming-with-ia.github.io/vDocs/hooks/use-read-local-storage)
 * @example
 * ```tsx
